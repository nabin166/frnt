...
const Profile = ({navigation}) => {
  ...
  return (
   ...
   <TouchableOpacity><View style={css.profileSection}><MaterialCommunityIcons style={{marginLeft:5}} name="cart-minus" size={54} color="black" />  <Text style={css.texts}>Cart</Text></View></TouchableOpacity> 
