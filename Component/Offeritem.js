...
const Offeritem = () => {
  ...
  useEffect( ()=>{
    axios
    .get('https://localhost:7222/api/Fetchdata/Offer')
    .then((response) => {
  ...
  return (
   ...
   }}> Daily Offer</Text><Text style={{color:'red' , marginLeft:10,marginBottom:20}}>Grab your food now , offer will close soon.</Text></View>

 
   {/*Item section */}

   <View>{offer.map((item , index)=>{
   ...
   <View style={css.container}>
    <View style={{flex:1}}>
        ...
        <View style={css.offerpercent}> <Text style={{textAlign:'center',color:'red',fontSize:23 , marginTop:7}}>{item.fdiscount}%</Text></View>
    </View>
