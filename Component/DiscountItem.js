...
const DiscountItem = () => {
  ...
  const [Todaydiscount , settodaydiscount] = useState([]);
  ...
  useEffect( ()=>{
    axios
    .get('https://localhost:7222/api/Fetchdata/TodayDiscount')
    .then((response) => {
      console.log("Response:", response.data);
      
      
      
       settodaydiscount(response.data);
  ...
  return (
   ...
   }}> Daily Discount Item</Text></View>

   {/*Item section */}

   <View>{Todaydiscount.map((item , index)=>{
