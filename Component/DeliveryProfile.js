...
const Profile = ({navigation}) => {
  ...
  return (
   ...
   <TouchableOpacity><View style={css.profileSection}><MaterialCommunityIcons style={{marginLeft:5}} name="cart-minus" size={54} color="black" />  <Text style={css.texts}>Total Delivery</Text></View></TouchableOpacity> 
  
   <TouchableOpacity> <View  style={css.profileSection}> <FontAwesome5 style={{marginLeft:5}} name="map-marked-alt" size={54} color="black" /><Text style={css.texts}>Map</Text></View></TouchableOpacity> 
 
  <TouchableOpacity > <View style={css.profileSection}> <AntDesign name="profile" style={{marginLeft:5}} size={54} color="black" /><Text style={css.texts}>Profile Setting</Text></View></TouchableOpacity> 
